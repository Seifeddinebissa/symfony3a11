...
class AuthorController extends AbstractController
{
    ...
    public function getAll(AuthorRepository $repo){
        ...
        return $this -> render('author/Listauthors.html.twig',['a' => $authors]);
    }
    ...
    #[Route('author/delete/nobook',name:'app_delete_author_nobook')]
    public function deleteNoBook(ManagerRegistry $manager,  AuthorRepository $repo){
        //$authors = $repo->findBy(['nb_books' => 0]);
        $authors = $manager->getRepository(Author::class)->findBy(['nb_books' => 0]);
